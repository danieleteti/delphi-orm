...
function TMappingCache.GetTypeInfo: PTypeInfo;
begin
  if Assigned(Self.RTTIField) then
    Exit(Self.RTTIField.FieldType.Handle);
  Result := Self.RTTIProp.PropertyType.Handle;
end;
