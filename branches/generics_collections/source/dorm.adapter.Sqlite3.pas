...
function TSqlite3PersistStrategy.List(ARttiType: TRttiType; ATableName: string;
  AFieldsMapping: TArray<TdormFieldMapping>;
  AdormSearchCriteria: IdormSearchCriteria): TdormCollection;
begin
  Result := NewList();
...
function TSqlite3PersistStrategy.Load(ARttiType: TRttiType; ATableName: string;
...
//procedure TSqlite3PersistStrategy.SetDBXParameterValue(aFieldType: string;
//  aParameter: TDBXParameter; aValue: TValue);
//begin
...
class procedure TSqlite3TableSequence.RegisterClass;
begin
  // do nothing
end;
